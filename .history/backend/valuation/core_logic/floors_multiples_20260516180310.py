...
import pandas as pd
from valuation.bist_registry import ValuationArchetype, FinancialGroupCode, SectorType
...
class ValuationSafeguards:
    ...
    # Zemin korumasının anlamlı olduğu modeller (Temettü modellerinde Bankalar için zaten Defter Değeri esastır)
