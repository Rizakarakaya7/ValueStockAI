...
class BistRegistryService:
    ...
    _registry: Dict[str, TickerConfig] = {
        ...
        # HAVACILIK
        "THYAO": TickerConfig(ticker="THYAO", sector=SectorType.HAVACILIK, archetype=CompanyArchetype.CAPACITY_GROWTH, reporting_template=ReportingTemplate.SANAYI),
        "PGSUS": TickerConfig(ticker="PGSUS", sector=SectorType.HAVACILIK, archetype=CompanyArchetype.CAPACITY_GROWTH, reporting_template=ReportingTemplate.SANAYI),
        ...
        "EREGL": TickerConfig(ticker="EREGL", sector=SectorType.DEMIR_CELIK, archetype=CompanyArchetype.CYCLICAL, reporting_template=ReportingTemplate.SANAYI),
