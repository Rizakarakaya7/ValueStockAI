...
class PipelineContext(BaseModel):
    job_id: str
    ticker: str
    config: Any  # BistRegistryService import döngüsünü kırması için Any yapılabilir veya TickerConfig kalabilir
    df: Optional[Any] = None 
    metadata: Dict[str, Any] = Field(default_factory=dict)
    telemetry: Dict[str, float] = Field(default_factory=dict)
    
    # DÜZELTİLDİ: Pydantic V2'ye uygun hale getirildi
