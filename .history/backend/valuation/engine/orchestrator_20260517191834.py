...
# Yeni YFinance Motoru (Eski ayrı extractor'lar yerine tek ve güçlü motor)
...
class ValuationOrchestrator:
    ...
    def __init__(self, state_manager: StateManager):
        ...
        # ============================================
        # Artık tek bir motor her şeyi hallediyor
    ...
    async def _step_extract_data(self, ctx: PipelineContext):
        ...
        try:
            # Yeni motor üzerinden tüm veriyi (finansallar + market data) tek seferde çekiyoruz
    ...
    def _step_normalize_data(self, ctx: PipelineContext):
        ...
        # Yeni normalizer metoduna (normalize_financials) bağlanıyoruz
