...
**Tarih:** {current_date} | **Sektör:** [Sektör Adı] | **Uygulanan Arketip:** [Arketip Adı]

## 1. YÖNETİCİ ÖZETİ (EXECUTIVE SUMMARY)
- Hissenin anlık piyasa fiyatını, hesaplanan HİSSE BAŞINA ADİL DEĞERİ / HEDEF FİYATI ve net getiri potansiyelini (% Upside/Downside) en başta vurgula.
- Toplam adil şirket değerini ve şirketin toplam hisse adedini belirterek hesaplamanın şeffaflığını kanıtla.
- Çıkan sonuca göre komiteye net duruşunu söyle.
