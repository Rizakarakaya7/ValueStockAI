...
# 1. EKLENTİ: .env dosyasındaki ortam değişkenlerini sisteme yükler
from dotenv import load_dotenv
load_dotenv()

# WINDOWS PLAYWRIGHT (SUBPROCESS) YAMASI
# Bu kod, Windows'ta Playwright'ın Chromium'u başlatabilmesi için gereklidir.
if sys.platform == "win32":
    asyncio.set_event_loop_policy(asyncio.WindowsProactorEventLoopPolicy())

# ... (Mevcut diğer importların ve FastAPI app tanımlamaların buradan sonra devam etsin)
