...
class YFinanceEngine:
    """
    BIST hisselerini rate-limit ve retry mekanizmaları ile korumalı olarak çeken motor.
    Not: requests_cache, yfinance'in crumb/cookie yapısını bozduğu için kaldırılmıştır.
    """
    def __init__(self):
        # 1. Standart Session (Caching kaldırıldı)
        ...
        # 3. Retry Stratejisi: Bağlantı hatalarında artan sürelerle tekrar deneme
