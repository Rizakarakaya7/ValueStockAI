...
class YFinanceEngine:
    ...
    def __init__(self):
        ...
        # Session korunuyor ama artık yfinance içine vermiyoruz
    ...
    def get_financials_sync(self, ticker: str) -> Dict[str, Any]:
        ...
        for attempt in range(3):
            try:
                ...
                # financials -> income_stmt değiştirildi
    ...
    async def fetch_all_data_async(self, ticker: str) -> Dict[str, Any]:
        ...
        financials = await asyncio.to_thread(
            self.get_financials_sync,
            ticker
        )

        market_data = await asyncio.to_thread(
            self.get_market_data_sync,
            ticker
        )
